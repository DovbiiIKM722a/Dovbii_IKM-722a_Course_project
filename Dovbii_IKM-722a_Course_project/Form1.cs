...
namespace Dovbii_IKM_722a_Course_project
{
    public partial class Form1 : Form
    {
        ...
        private void bStart_Click(object sender, EventArgs e)
        {
            if (Mode)
            {
                tbInput.Enabled = true;// Режим дозволув ведення
                tbInput.Focus();
                tClock.Start();
        ...
        private void зберегтиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (MajorObject.SaveFileNameExists()) // задане ім’я файлу існує?
                ...
                зберегтиЯкToolStripMenuItem_Click(sender, e); //зберегти файли в "ім'я файлу", яке буде введене у форму для збереження
        }
